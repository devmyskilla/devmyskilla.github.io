...
function renderPlatform(p, renderSimilarToo=true) {
  ...
  const html=`<article class="detail-content">
    <div class="detail-hero">
      <div class="detail-logo-wrap">${p.thumbnail?`<img class="detail-thumb" src="${escapeHtml(p.thumbnail)}" alt="${escapeHtml(name)}" onerror="this.replaceWith(Object.assign(document.createElement('div'),{className:'detail-thumb-placeholder',textContent:'🌐'}))">`:`<div class="detail-thumb-placeholder">🌐</div>`}</div>
