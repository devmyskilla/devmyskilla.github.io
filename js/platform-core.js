(function(root, factory){
  ...
  function normalizeSupabasePlatform(row={}){
    ...
    Object.assign(out, {
      ...
      pricingModel:meaningful(row.pricing_model) ? text(row.pricing_model) : 'unknown',
      hasFreeContent:row.has_free_content === true, certificateAvailable:row.certificate_available === true,
